...
if [ "$OS" = "Darwin" ]; then
    OS="mac"
    BINARY="MediaConch-Policy.app/Contents/MacOS/MediaConch-Policy"
...
echo "MediaConch-Policy executable is MediaConch/Project/Qt/$BINARY"
